...
export default {
    ...
    avgMonthlyBill() {
        let data = JSON.parse(localStorage.getItem("jsonToSendForCalculation")).additional_info_for_frontend.homeInfo.avgMonthlyBill;
        ...
        if (Object.keys(errors).length === 0) {
            ...
            try {
                const postData = {
                    ...
                    "phone": this.dialCode + ' ' + this.userInfo.mobileNo,
